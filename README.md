...
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | **3** | **76.7** | 86.1 | 0 | 219.914ms |
| ffd | **3** | **76.7** | 88.1 | 0 | 115.787ms |
| bfd | **3** | **76.7** | 88.1 | 0 | 116.699ms |
| nfd | **3** | **76.7** | 82.2 | 0 | 103.049ms |
| blf | **3** | **76.7** | 86.6 | 0 | 196.964ms |
| ems | **3** | **76.7** | 86.8 | 0 | 16.613ms |
| heightmap | **3** | **76.7** | 83.2 | 0 | 471.978ms |
| laff | 4 | 57.5 | 68.7 | 0 | 2.018ms |
| layer | **3** | **76.7** | 82.1 | 0 | **893µs** |
| blocks | **3** | **76.7** | 88.9 | 0 | 6.669ms |
| assemble | **3** | **76.7** | **91.2** | 0 | 10.45ms |
| auto | **3** | **76.7** | 88.1 | 0 | 142.076ms |

### 3D · anti-slosh — same 500 boxes with 60% bottom support + 50% side anti-slosh (X & Y)

| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 3 | 76.7 | 85.7 | 0 | 225.787ms |
| ffd | 3 | 76.7 | 89.4 | 0 | 161.545ms |
| bfd | 3 | 76.7 | 89.4 | 0 | 161.311ms |
| nfd | 3 | 76.7 | 80.6 | 0 | 226.559ms |
| blf | 3 | 76.7 | 86.6 | 0 | 197.347ms |
| ems | 3 | 76.7 | 85.2 | 0 | 23.964ms |
| heightmap | 3 | 76.7 | 86.5 | 0 | 476.475ms |
| layer | 3 | 76.7 | 82.1 | 0 | **1.571ms** |
| blocks | 3 | 76.7 | 88.9 | 0 | 6.899ms |
| assemble | 3 | 76.7 | **91.2** | 0 | 10.59ms |

### 3D · carton SKUs — 400 boxes from a 10-SKU palette (sizes divide the bin) into 12×12×12

| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 26 | 89.3 | 89.7 | 0 | 5.149ms |
| ffd | **24** | **96.7** | 97.0 | 0 | 2.455ms |
| bfd | **24** | **96.7** | 97.0 | 0 | 2.442ms |
| nfd | 26 | 89.3 | 93.8 | 0 | **708µs** |
| blf | 26 | 89.3 | 91.4 | 0 | 5.961ms |
| ems | 26 | 89.3 | 90.2 | 0 | 2.29ms |
| heightmap | 27 | 86.0 | 87.3 | 0 | 18.082ms |
| laff | 27 | 86.0 | 89.3 | 0 | 4.353ms |
| layer | 27 | 86.0 | 87.4 | 0 | 1.531ms |
| blocks | **24** | **96.7** | **98.2** | 0 | 6.15ms |
| assemble | **24** | **96.7** | 97.5 | 0 | 1.145ms |
| auto | **24** | **96.7** | 97.0 | 0 | 6.383ms |
...
| ems | — | — | — | — | **DNF** |
| heightmap | — | — | — | — | **DNF** |
| laff | 2 | 43.6 | 71.6 | 0 | 78.554ms |
| layer | **1** | **87.2** | 90.9 | 0 | **64.704ms** |
| blocks | **1** | **87.2** | **94.8** | 0 | 840.975ms |
| assemble | — | — | — | — | **DNF** |
| auto | — | — | — | — | **DNF** |
...
| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 4 | 71.1 | 93.0 | 0 | 2.01ms |
| ffd | **3** | **94.8** | **95.0** | 0 | 2.4ms |
| bfd | **3** | **94.8** | **95.0** | 0 | 2.357ms |
| nfd | 4 | 71.1 | 86.9 | 0 | 1.785ms |
| skyline | 4 | 71.1 | 83.8 | 0 | **301µs** |
| auto | **3** | **94.8** | **95.0** | 0 | 3.179ms |

### 1D — 1000 mixed items (1–8) into capacity-10 bins

| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 418 | 99.4 | 100.0 | 0 | **1.013ms** |
| bf | 418 | 99.4 | 100.0 | 0 | 1.118ms |
| wf | 464 | 89.6 | 100.0 | 0 | 1.806ms |
| ffd | **416** | **99.9** | 100.0 | 0 | 1.174ms |
| bfd | **416** | **99.9** | 100.0 | 0 | 1.496ms |
| wfd | **416** | **99.9** | 100.0 | 0 | 1.492ms |
| mffd | **416** | **99.9** | 100.0 | 0 | 1.195ms |
| auto | **416** | **99.9** | 100.0 | 0 | 1.884ms |
