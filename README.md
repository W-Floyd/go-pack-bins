...
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | **3** | **76.7** | 86.1 | 0 | 21.804ms |
| ffd | **3** | **76.7** | 88.1 | 0 | 16.941ms |
| bfd | **3** | **76.7** | 88.1 | 0 | 16.871ms |
| nfd | **3** | **76.7** | 82.2 | 0 | 14.371ms |
| blf | **3** | **76.7** | 86.6 | 0 | 185.36ms |
| ems | **3** | **76.7** | 86.8 | 0 | 4.707ms |
| fit | **3** | **76.7** | 76.7 | 0 | 25.013ms |
| heightmap | **3** | **76.7** | 83.2 | 0 | 458.15ms |
| laff | 4 | 57.5 | 68.7 | 0 | 1.769ms |
| layer | **3** | **76.7** | 82.1 | 0 | **940µs** |
| blocks | **3** | **76.7** | 89.0 | 0 | 5.245ms |
| assemble | **3** | **76.7** | **91.2** | 0 | 5.19ms |
| rr | — | — | — | — | **DNF** |
| arr | — | — | — | — | **DNF** |
...
| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 3 | 76.7 | 85.7 | 0 | 58.179ms |
| ffd | 3 | 76.7 | 89.4 | 0 | 58.933ms |
| bfd | 3 | 76.7 | 89.4 | 0 | 58.595ms |
| nfd | 3 | 76.7 | 80.6 | 0 | 148.193ms |
| blf | 3 | 76.7 | 86.6 | 0 | 192.062ms |
| ems | 3 | 76.7 | 85.2 | 0 | 10.364ms |
| heightmap | 3 | 76.7 | 86.5 | 0 | 481.708ms |
| layer | 3 | 76.7 | 82.1 | 0 | **1.675ms** |
| blocks | 3 | 76.7 | 89.0 | 0 | 5.773ms |
| assemble | 3 | 76.7 | **91.2** | 0 | 5.681ms |

### 3D · carton SKUs — 400 boxes from a 10-SKU palette (sizes divide the bin) into 12×12×12

| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 26 | 89.3 | 89.7 | 0 | 4.998ms |
| ffd | **24** | **96.7** | 97.0 | 0 | 2.454ms |
| bfd | **24** | **96.7** | 97.0 | 0 | 2.442ms |
| nfd | 26 | 89.3 | 93.8 | 0 | **778µs** |
| blf | 26 | 89.3 | 91.4 | 0 | 6.376ms |
| ems | 26 | 89.3 | 90.2 | 0 | 1.935ms |
| fit | 26 | 89.3 | 93.2 | 0 | 1.761ms |
| heightmap | 27 | 86.0 | 87.3 | 0 | 18.817ms |
| laff | 27 | 86.0 | 89.3 | 0 | 4.396ms |
| layer | 27 | 86.0 | 87.4 | 0 | 1.622ms |
| blocks | **24** | **96.7** | **97.6** | 0 | 6.221ms |
| assemble | **24** | **96.7** | 97.5 | 0 | 1.345ms |
...
| nfd | — | — | — | — | **DNF** |
| blf | — | — | — | — | **DNF** |
| ems | **1** | **87.2** | 93.5 | 0 | 1.858383s |
| heightmap | — | — | — | — | **DNF** |
| laff | 2 | 43.6 | 71.6 | 0 | **79.791ms** |
| layer | **1** | **87.2** | 90.9 | 0 | 191.557ms |
| blocks | **1** | **87.2** | **96.2** | 0 | 690.248ms |
| assemble | — | — | — | — | **DNF** |
...
| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 4 | 71.1 | 93.0 | 0 | 1.813ms |
| ffd | **3** | **94.8** | **95.0** | 0 | 2.296ms |
| bfd | **3** | **94.8** | **95.0** | 0 | 2.327ms |
| nfd | 4 | 71.1 | 86.9 | 0 | 1.733ms |
| skyline | 4 | 71.1 | 83.8 | 0 | **305µs** |

### 1D — 1000 mixed items (1–8) into capacity-10 bins

| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 418 | 99.4 | 100.0 | 0 | **1.014ms** |
| bf | 418 | 99.4 | 100.0 | 0 | 1.088ms |
| wf | 464 | 89.6 | 100.0 | 0 | 1.714ms |
| ffd | **416** | **99.9** | 100.0 | 0 | 1.163ms |
| bfd | **416** | **99.9** | 100.0 | 0 | 1.606ms |
| wfd | **416** | **99.9** | 100.0 | 0 | 1.503ms |
| mffd | **416** | **99.9** | 100.0 | 0 | 1.156ms |
