...
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | **3** | **76.7** | 86.1 | 0 | 24.86ms |
| ffd | **3** | **76.7** | 88.1 | 0 | 18.492ms |
| bfd | **3** | **76.7** | 88.1 | 0 | 18.516ms |
| nfd | **3** | **76.7** | 82.2 | 0 | 16.014ms |
| blf | **3** | **76.7** | 86.6 | 0 | 65.745ms |
| ems | **3** | **76.7** | 86.8 | 0 | 4.906ms |
| fit | **3** | **76.7** | 76.7 | 0 | 26.465ms |
| heightmap | **3** | **76.7** | 83.2 | 0 | 511.246ms |
| laff | 4 | 57.5 | 68.7 | 0 | 2.155ms |
| layer | **3** | **76.7** | 82.1 | 0 | **584µs** |
| blocks | **3** | **76.7** | **97.0** | 0 | 6.019ms |
| columns | **3** | **76.7** | 91.9 | 0 | 5.128ms |
| assemble | **3** | **76.7** | 91.2 | 0 | 5.665ms |
| rr | **3** | **76.7** | 90.0 | 0 | 5.286ms |
| arr | **3** | **76.7** | 90.0 | 0 | 5.288ms |
<!-- BENCH:3d-mixed:END -->
...
| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 3 | 76.7 | 85.7 | 0 | 62.581ms |
| ffd | 3 | 76.7 | 89.4 | 0 | 62.358ms |
| bfd | 3 | 76.7 | 89.4 | 0 | 62.43ms |
| nfd | 3 | 76.7 | 80.6 | 0 | 155.428ms |
| blf | 3 | 76.7 | 86.6 | 0 | 65.922ms |
| ems | 3 | 76.7 | 85.2 | 0 | 10.593ms |
| heightmap | 3 | 76.7 | 86.5 | 0 | 512.995ms |
| layer | 3 | 76.7 | 82.1 | 0 | **1.255ms** |
| blocks | 3 | 76.7 | **97.0** | 0 | 5.948ms |
| assemble | 3 | 76.7 | 91.2 | 0 | 5.714ms |
| rr | 3 | 76.7 | 90.2 | 0 | 8.444ms |
| arr | 3 | 76.7 | 90.2 | 0 | 8.5ms |
<!-- BENCH:3d-slosh:END -->
...
| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 26 | 89.3 | 89.7 | 0 | 3.65ms |
| ffd | **24** | **96.7** | 97.0 | 0 | 2.116ms |
| bfd | **24** | **96.7** | 97.0 | 0 | 2.045ms |
| nfd | 26 | 89.3 | 93.8 | 0 | 746µs |
| blf | 26 | 89.3 | 91.4 | 0 | 4.964ms |
| ems | 26 | 89.3 | 90.2 | 0 | 478µs |
| fit | 26 | 89.3 | 93.2 | 0 | 593µs |
| heightmap | 27 | 86.0 | 87.3 | 0 | 16.786ms |
| laff | 27 | 86.0 | 89.3 | 0 | 4.958ms |
| layer | 27 | 86.0 | 87.4 | 0 | 413µs |
| blocks | **24** | **96.7** | **98.6** | 0 | 5.953ms |
| columns | **24** | **96.7** | 97.9 | 0 | 1.573ms |
| assemble | **24** | **96.7** | 97.5 | 0 | 1.004ms |
| rr | **24** | **96.7** | 98.0 | 0 | **383µs** |
| arr | **24** | **96.7** | 98.0 | 0 | 399µs |
...
| nfd | — | — | — | — | **DNF** |
| blf | — | — | — | — | **DNF** |
| ems | **1** | **87.2** | 93.5 | 0 | 1.892475s |
| fit | — | — | — | — | **DNF** |
| heightmap | — | — | — | — | **DNF** |
| laff | 2 | 43.6 | 71.6 | 0 | **87.447ms** |
| layer | **1** | **87.2** | 90.9 | 0 | 195.606ms |
| blocks | **1** | **87.2** | **97.7** | 0 | 647.088ms |
| columns | **1** | **87.2** | 87.2 | 0 | 2.501273s |
| assemble | — | — | — | — | **DNF** |
| rr | **1** | **87.2** | 94.8 | 0 | ≤4s |
...
| fit | 4 | 70.7 | 92.0 | 0 | 19µs |
| columns | 4 | 70.7 | 93.5 | 0 | 32µs |
| blocks | 5 | 56.5 | 88.3 | 0 | 213µs |
| assemble | 4 | 70.7 | 93.5 | 0 | 58µs |
| rr | **3** | **94.2** | **94.2** | 0 | 7.42ms |
| arr | **3** | **94.2** | **94.2** | 0 | 426µs |
<!-- BENCH:3d-chunky:END -->
...
| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 4 | 71.1 | 93.0 | 0 | 1.98ms |
| ffd | **3** | **94.8** | **95.0** | 0 | 2.426ms |
| bfd | **3** | **94.8** | **95.0** | 0 | 2.469ms |
| nfd | 4 | 71.1 | 86.9 | 0 | 1.83ms |
...
| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 418 | 99.4 | 100.0 | 0 | **1.047ms** |
| bf | 418 | 99.4 | 100.0 | 0 | 1.147ms |
| wf | 464 | 89.6 | 100.0 | 0 | 1.828ms |
| ffd | **416** | **99.9** | 100.0 | 0 | 1.204ms |
| bfd | **416** | **99.9** | 100.0 | 0 | 1.576ms |
| wfd | **416** | **99.9** | 100.0 | 0 | 1.608ms |
| mffd | **416** | **99.9** | 100.0 | 0 | 1.206ms |
<!-- BENCH:1d:END -->
