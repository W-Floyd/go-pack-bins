...
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | **3** | **76.7** | 86.1 | 0 | 217.943ms |
| ffd | **3** | **76.7** | 88.1 | 0 | 123.59ms |
| bfd | **3** | **76.7** | 88.1 | 0 | 123.988ms |
| nfd | **3** | **76.7** | 82.2 | 0 | 104.323ms |
| blf | **3** | **76.7** | 86.6 | 0 | 186.996ms |
| ems | **3** | **76.7** | 86.8 | 0 | 4.701ms |
| fit | **3** | **76.7** | 76.7 | 0 | 24.685ms |
| heightmap | **3** | **76.7** | 83.2 | 0 | 483.059ms |
| laff | 4 | 57.5 | 68.7 | 0 | 1.99ms |
| layer | **3** | **76.7** | 82.1 | 0 | **1.138ms** |
| blocks | **3** | **76.7** | 89.0 | 0 | 7.761ms |
| assemble | **3** | **76.7** | **91.2** | 0 | 5.448ms |
| rr | — | — | — | — | **DNF** |
| arr | — | — | — | — | **DNF** |
...
| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 3 | 76.7 | 85.7 | 0 | 228.03ms |
| ffd | 3 | 76.7 | 89.4 | 0 | 164.481ms |
| bfd | 3 | 76.7 | 89.4 | 0 | 164.755ms |
| nfd | 3 | 76.7 | 80.6 | 0 | 227.658ms |
| blf | 3 | 76.7 | 86.6 | 0 | 190.189ms |
| ems | 3 | 76.7 | 85.2 | 0 | 10.774ms |
| heightmap | 3 | 76.7 | 86.5 | 0 | 495.876ms |
| layer | 3 | 76.7 | 82.1 | 0 | **1.779ms** |
| blocks | 3 | 76.7 | 89.0 | 0 | 7.783ms |
| assemble | 3 | 76.7 | **91.2** | 0 | 5.168ms |

### 3D · carton SKUs — 400 boxes from a 10-SKU palette (sizes divide the bin) into 12×12×12

| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 26 | 89.3 | 89.7 | 0 | 5.409ms |
| ffd | **24** | **96.7** | 97.0 | 0 | 2.739ms |
| bfd | **24** | **96.7** | 97.0 | 0 | 2.539ms |
| nfd | 26 | 89.3 | 93.8 | 0 | **751µs** |
| blf | 26 | 89.3 | 91.4 | 0 | 6.497ms |
| ems | 26 | 89.3 | 90.2 | 0 | 1.919ms |
| fit | 26 | 89.3 | 93.2 | 0 | 1.856ms |
| heightmap | 27 | 86.0 | 87.3 | 0 | 18.169ms |
| laff | 27 | 86.0 | 89.3 | 0 | 4.128ms |
| layer | 27 | 86.0 | 87.4 | 0 | 1.433ms |
| blocks | **24** | **96.7** | **97.6** | 0 | 7.931ms |
| assemble | **24** | **96.7** | 97.5 | 0 | 1.257ms |
...
| nfd | — | — | — | — | **DNF** |
| blf | — | — | — | — | **DNF** |
| ems | **1** | **87.2** | 93.5 | 0 | 1.837482s |
| heightmap | — | — | — | — | **DNF** |
| laff | 2 | 43.6 | 71.6 | 0 | **78.619ms** |
| layer | **1** | **87.2** | 90.9 | 0 | 186.836ms |
| blocks | **1** | **87.2** | **96.2** | 0 | 981.797ms |
| assemble | — | — | — | — | **DNF** |
...
| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 4 | 71.1 | 93.0 | 0 | 1.969ms |
| ffd | **3** | **94.8** | **95.0** | 0 | 2.225ms |
| bfd | **3** | **94.8** | **95.0** | 0 | 2.232ms |
| nfd | 4 | 71.1 | 86.9 | 0 | 1.645ms |
| skyline | 4 | 71.1 | 83.8 | 0 | **338µs** |

### 1D — 1000 mixed items (1–8) into capacity-10 bins

| Algorithm | Bins ↓ | Fill % ↑ | Compact % ↑ | Unfit ↓ | Time/op ↓ |
|-----------|-------:|---------:|------------:|--------:|----------:|
| ff | 418 | 99.4 | 100.0 | 0 | **924µs** |
| bf | 418 | 99.4 | 100.0 | 0 | 1.002ms |
| wf | 464 | 89.6 | 100.0 | 0 | 1.588ms |
| ffd | **416** | **99.9** | 100.0 | 0 | 1.069ms |
| bfd | **416** | **99.9** | 100.0 | 0 | 1.455ms |
| wfd | **416** | **99.9** | 100.0 | 0 | 1.31ms |
